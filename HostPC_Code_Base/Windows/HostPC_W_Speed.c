...
//# define Ploss1 (unsigned int) 999 // probability of packet loss on state
...
//
struct sockaddr_in SRVRADDR, CLIENTADDR1, CLIENTADDR2, SPEEDADDR, LOCALLOOP, ARDSRVR;
int main(void)
{
  // Initialize winsock
  WSADATA wsa;
  ...
  *sendbuf = DSET;
  ...
  int mysock, slen1, ardsock, speedsock, slen2, slen3 = sizeof(SRVRADDR) , recv_len;
